...
namespace DDCalc
{
  ...
  {
    return C_DDCalc_xenon100_2012_init();
  }
  
  int LUX_2013_Init()
  {
    return C_DDCalc_lux_2013_init();
  }
  
  int LUX_2016_Init()
  {
    return C_DDCalc_lux_2016_init();
  }
  
  int PandaX_2016_Init()
  {
    return C_DDCalc_pandax_2016_init();
  }

  int PandaX_2017_Init()
  {
    return C_DDCalc_pandax_2017_init();
  }

  int XENON1T_2017_Init()
  {
    return C_DDCalc_xenon1t_2017_init();
  }

  int XENON1T_2018_Init()
  {
    return C_DDCalc_xenon1t_2018_init();
  }

  int LUX_2015_Init()
  {
    return C_DDCalc_lux_2015_init();
  }

  int PICO_2L_Init()
  {
    return C_DDCalc_pico_2l_init();
  }

  int PICO_60_Init()
  {
    return C_DDCalc_pico_60_init();
  }

  int PICO_60_2017_Init()
  {
    return C_DDCalc_pico_60_2017_init();
  }
 
  int PICO_60_2019_Init()
  {
    return C_DDCalc_pico_60_2019_init();
  }
 
  int SuperCDMS_2014_Init()
  {
    return C_DDCalc_supercdms_2014_init();
  }

  int CDMSLite_Init()
  {
    return C_DDCalc_cdmslite_init();
  }
  
  int SIMPLE_2014_Init()
  {
    return C_DDCalc_simple_2014_init();
  }

  int CRESST_II_Init()
  {
    return C_DDCalc_cresst_ii_init();
  }
  
  int LZ_Init()
  {
    return C_DDCalc_lz_init();
  }

  int DARWIN_Init()
  {
    return C_DDCalc_darwin_init();
  }

  int DarkSide_20k_Init()
  {
    return C_DDCalc_darkside_20k_init();
  }

  int DarkSide_50_Init()
  {
    return C_DDCalc_darkside_50_init();
  }

  int DarkSide_50_S2_Init()
  {
    return C_DDCalc_darkside_50_s2_init();
  }

  int PICO_500_Init()
  {
    return C_DDCalc_pico_500_init();
  }
