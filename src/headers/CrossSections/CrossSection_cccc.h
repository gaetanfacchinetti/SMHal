#ifndef DEF_CROSSSECTION_CCCC
#define DEF_CROSSSECTION_CCCC

#include "CrossSection.h"
#include "../DarkSectorModel.h"

class CrossSection_cccc : public CrossSection
{

public:
  CrossSection_cccc(DarkSectorModel const &DSMod, Particle const &chi);
  virtual ~CrossSection_cccc(){};
